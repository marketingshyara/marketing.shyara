      ...
      <section className="py-20 lg:py-28 bg-[hsl(var(--surface))]">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-foreground">End-to-End Campaign Management</h2>
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-foreground">Simple. Transparent. Fair.</h2>
          </div>
          <div className="rounded-2xl border-2 border-accent/40 bg-accent/5 p-8 max-w-2xl mx-auto text-center">
      ...
      <section className="py-16 bg-background">
        <div className="container max-w-3xl mx-auto">
          <div className="rounded-2xl border border-border bg-card p-8 text-center">
            <h2 className="text-2xl font-bold text-foreground mb-2">Let&apos;s Discuss Your Campaign Goals</h2>
