          ...
          <div className="grid lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-4">
              ...
              <button
                ...
                className="w-full rounded-2xl border-2 border-[#25D366] bg-[#25D366]/5 hover:bg-[#25D366]/10 p-6 text-left flex items-center gap-4 transition-all duration-300 group cursor-pointer"
              >
                <div className="w-14 h-14 rounded-xl bg-[#25D366] flex items-center justify-center flex-shrink-0">
                  <MessageCircle className="h-7 w-7 text-white" />
                </div>
                <div className="flex-1">
                  <div className="font-semibold text-foreground text-base">Chat on WhatsApp</div>
                  <div className="text-sm text-muted-foreground">Fastest way to reach us — typical reply in 2–4 hours</div>
                  <div className="text-xs text-[#25D366] font-medium mt-1 group-hover:gap-1.5 flex items-center gap-1 transition-all">
                    Open WhatsApp →
                  </div>
                </div>
              </button>
              ...
              <a
                ...
                className="w-full rounded-2xl border border-border bg-card hover:border-accent/40 hover:shadow-md p-6 text-left flex items-center gap-4 transition-all duration-300 block"
              >
                <div className="icon-well-lg flex-shrink-0">
                  <Mail className="h-7 w-7 text-accent" />
                </div>
                <div>
                  <div className="font-semibold text-foreground text-base">Email Us</div>
                  <div className="text-sm text-muted-foreground">marketing.shyara@gmail.com</div>
                  <div className="text-xs text-accent font-medium mt-1">Expect a reply within 24 hours</div>
                </div>
              </a>

              {/* Business hours info */}
              <div className="rounded-xl bg-[hsl(var(--surface))] border border-border p-4 flex items-start gap-3">
      ...
      <section className="py-20 lg:py-28 bg-[hsl(var(--surface))]">
        <div className="container">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl font-bold text-foreground">Before You Reach Out</h2>
            <p className="text-muted-foreground mt-2 text-sm">These are the most common things people wonder before messaging us.</p>
          </div>
