          ...
          <div className="max-w-3xl mx-auto">
            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
              ...
              <section className="space-y-4">
                ...
                <p className="text-body text-muted-foreground leading-relaxed">We may collect:</p>
              ...
              <section className="space-y-4">
                ...
                <p className="text-body text-muted-foreground leading-relaxed">We use your information to:</p>
