  ...
  return (
    <Layout>
      ...
      <section className="py-20 lg:py-28 bg-[hsl(var(--surface))]">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-section font-bold text-foreground">Your Website Is Your First Salesperson</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {whyMatters.map((item) => (
              <div key={item.stat} className="rounded-card border border-border bg-card p-7 text-center shadow-sm">
      ...
      <section className="py-20 lg:py-28 bg-background">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-section font-bold text-foreground">Choose the Right Tier</h2>
      ...
      <section className="py-20 lg:py-28 bg-[hsl(var(--surface))]">
        <div className="container">
          <div className="text-center mb-12">
            ...
            <h2 className="text-section font-bold text-foreground">How Website Projects Work</h2>
          </div>
      ...
      <section className="py-16 bg-ctaBand border-l-4 border-accent text-white">
        <div className="container max-w-3xl mx-auto text-center">
          <h2 className="text-section font-bold mb-2">Ready to Build Your Website?</h2>
