...
export default function Offers() {
  ...
  return (
    <Layout>
      ...
      <section className="gradient-hero py-20 lg:py-28">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <span className="section-label inline-flex items-center gap-2 rounded-full border border-accent/30 bg-accent/10 px-4 py-1.5 mb-6">
              <Sparkles className="h-4 w-4" />
              Limited Time Offers
            </span>
            <h1 className="text-hero md:text-display font-bold mb-6 text-foreground">
              Special Offers
            </h1>
      ...
      {/* Offers Section */}
      <section className="pb-20 lg:py-28 bg-[hsl(var(--surface))]">
        <div className="container">
          <div className="grid gap-8 max-w-5xl mx-auto">
            {offers.map((offer) => (
              <Card key={offer.id} className="overflow-hidden border-accent/30 bg-gradient-to-br from-card to-accent/5 shadow-card">
                <div className="grid md:grid-cols-2 gap-0">
                  ...
                  <div className="relative overflow-hidden bg-accent/5">
                    ...
                    <div className="absolute top-4 left-4">
                      <span className="bg-accent text-accent-foreground text-small font-bold px-4 py-2 rounded-lg">
                        {offer.highlight}
                      </span>
                    </div>
                  </div>
          ...
          <div className="mt-16 max-w-4xl mx-auto">
            <h2 className="text-section font-bold text-center mb-8 text-foreground">Why Choose Our Website Solutions?</h2>
            <div className="grid md:grid-cols-3 gap-6">
              <div className="text-center p-6 rounded-card bg-card border border-border shadow-card">
                <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center mx-auto mb-4">
                  <TrendingUp className="h-6 w-6 text-accent" />
                </div>
                <h3 className="font-semibold mb-2 text-foreground">Better Rankings</h3>
                <p className="text-small text-muted-foreground">SEO-optimized websites that rank higher on Google search results.</p>
              </div>
              <div className="text-center p-6 rounded-card bg-card border border-border shadow-card">
                <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center mx-auto mb-4">
                  <Smartphone className="h-6 w-6 text-accent" />
                </div>
                <h3 className="font-semibold mb-2 text-foreground">Mobile First</h3>
                <p className="text-small text-muted-foreground">Fully responsive designs that look great on all devices.</p>
              </div>
              <div className="text-center p-6 rounded-card bg-card border border-border shadow-card">
                <div className="w-12 h-12 rounded-full bg-accent/10 flex items-center justify-center mx-auto mb-4">
                  <Search className="h-6 w-6 text-accent" />
                </div>
                <h3 className="font-semibold mb-2 text-foreground">AI Discovery</h3>
                <p className="text-small text-muted-foreground">SEO helps ChatGPT & Gemini recommend your business to users.</p>
              </div>
            </div>
          </div>
        </div>
